...
def get_total_CN(cov_file):
    ...
    return [str(int(total_cn)), round(av_2d6_cov), str(int(in1_3pr)), round(av_2d8_cov), str(ex9_3pr), round(av_in1_3pr), str(av_in4_3pr), str(av_5pr_in4), str(av_2d7_ex9), str(av_2d7_in4_in8)];
